...
?>
	...
	<?php 
		...
		<form action="./vistas/update.php" method="POST" class="FormularioAjax codigoform">
			...
			<label for="enfermero_dni">Email</label>
			<input type="email" name="new_email" placeholder="Email" value = <?php echo $email?> required>

			<label for="enfermero_dni">Número de teléfono</label>
			<input type="number" name="new_telefono" placeholder="Email" value = <?php echo $telefono?> required>
